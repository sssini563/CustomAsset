...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Documents approval custom gates (can be mapped later to roles/permissions system)
        Gate::define('documents.approve.it', function($user){
            return $user->hasAccess('admin') || $user->hasAccess('assets.manage') || $user->isSuperUser();
        });
        Gate::define('documents.approve.superior', function($user){
            return $user->hasAccess('admin') || $user->isSuperUser();
        });

                        ...
                        <li>
                            <a href="#files" data-toggle="tab">
                                ...
                                <span class="hidden-xs hidden-sm">{{ trans('general.file_uploads') }}
                                    {!! $component->uploads->count() > 0
                                        ? '<span class="badge badge-secondary">' . number_format($component->uploads->count()) . '</span>'
                                        : '' !!}
                                </span>
                            </a>
                        </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="checkedout">
                        <div class="table table-responsive">
                            ...
                            <table data-cookie-id-table="componentsCheckedoutTable"
                                data-id-table="componentsCheckedoutTable" data-side-pagination="server"
                                data-show-footer="true" data-sort-order="asc" data-sort-name="name"
                                id="componentsCheckedoutTable" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="history">
                        <div class="table-responsive">
                            ...
                            <table data-columns="{{ \App\Presenters\HistoryPresenter::dataTableLayout() }}"
                                class="table table-striped snipe-table" id="componentHistory"
                                data-id-table="componentHistory" data-side-pagination="server" data-sort-order="desc"
                         ...
                         "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                                ...
                                data-cookie-id-table="componentHistory" data-cookie="true">
                            </table>
                        </div>
                    </div><!-- /.tab-pane -->
                ...
                <div class="col-md-12 hidden-print" style="padding-top: 30px; padding-bottom: 30px;">
                    @if ($component->isDeletable())
                        <button
                            ...
                            class="btn btn-sm btn-block btn-danger btn-social delete-asset" data-icon="fa fa-trash"
                    ...
                    @else
                        <a href="#"
                            ...
                            class="btn btn-block btn-sm btn-danger btn-social hidden-print disabled" data-tooltip="true"
...
@section('moar_scripts')
    @include ('partials.bootstrap-table', [
        'exportFile' => 'component' . $component->name . '-export',
        'search' => false,
    ])
@stop

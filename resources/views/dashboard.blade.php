...
@section('content')
    ...
    {{-- Row 1: 6 Cards (Left) + Chart (Middle) + Categories (Right) --}}
    <div class="row">
        {{-- LEFT: 6 Cards in 3x2 grid --}}
                        ...
                        <div class="dashboard small-box bg-teal">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format(\App\Models\Asset::AssetsForShow()->count()) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.assets') }}</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <a href="{{ route('licenses.index') }}" aria-hidden="true"
                        ...
                        <div class="dashboard small-box bg-maroon">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format($counts['license']) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.licenses') }}</p>
                            </div>
                            <div class="icon" aria-hidden="true">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <a href="{{ route('accessories.index') }}"
                        ...
                        <div class="dashboard small-box bg-orange">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format($counts['accessory']) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.accessories') }}</p>
                            </div>
                            <div class="icon" aria-hidden="true">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <a href="{{ route('consumables.index') }}"
                        ...
                        <div class="dashboard small-box bg-purple">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format($counts['consumable']) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.consumables') }}</p>
                            </div>
                            <div class="icon" aria-hidden="true">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <a href="{{ route('components.index') }}"
                        ...
                        <div class="dashboard small-box bg-yellow">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format($counts['component']) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.components') }}</p>
                            </div>
                            <div class="icon" aria-hidden="true">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <a href="{{ route('users.index') }}"
                        ...
                        <div class="dashboard small-box bg-blue">
                            <div class="inner">
                                <h3 style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ number_format($counts['user']) }}</h3>
                                <p style="text-decoration: none !important; border-bottom: none !important;">
                                    {{ trans('general.people') }}</p>
                            </div>
                            <div class="icon" aria-hidden="true">
                                <x-icon type="users" />
                            </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-3" data-visible="true" data-field="category_type"
                                        data-sortable="true" style="padding: 4px 6px;">{{ trans('general.type') }}</th>
    ...
    {{-- Row 2: 2 Equal Sections (Recent Activity, Locations) --}}
                    ...
                    <div class="box-body" style="padding: 3px;">
                        <div class="table-responsive">
                            <table data-cookie-id-table="dashActivityReport" data-height="350" data-pagination="false"
                                ...
                                data-url="{{ route('api.activity.index', ['limit' => 15, 'order' => 'desc']) }}"
                                style="font-size: 11px; margin-bottom: 0;">
                                <thead>
                                    <tr>

<div class="modal-header">
  ...
  <h4 class="modal-title"><i class="fa fa-file-text-o text-info"></i> Detail Accessory <strong>{{ $document->document_number }}</strong>
...
<div class="modal-body doc-detail-modal">
  ...
  <div class="detail-section">
    <h5><i class="fa fa-plug"></i> Accessory Details</h5>
    <div class="doc-detail-grid">
      <div class="doc-detail-item"><dt>Part Number</dt><dd>{{ $document->accessory_part_number ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Serial Number</dt><dd>{{ $document->accessory_serial_number ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Condition</dt><dd>{{ $document->accessory_condition ?: '' }}</dd></div>
      @if(!empty($document->accessory_notes))
      <div class="doc-detail-item" style="width:100%"><dt>Notes</dt><dd>{{ $document->accessory_notes }}</dd></div>
      @endif

...
<body>
  <div class="container">
    ...
    <table class="main-table">
      ...
      <tr><td colspan="3" class="header-row">Accessory Details</td></tr>
      <tr><td class="label-cell">Part Number</td><td class="colon-cell">:</td><td>{{ $document->accessory_part_number ?: '' }}</td></tr>
      <tr><td class="label-cell">Serial Number</td><td class="colon-cell">:</td><td>{{ $document->accessory_serial_number ?: '' }}</td></tr>
      <tr><td class="label-cell">Condition</td><td class="colon-cell">:</td><td>{{ $document->accessory_condition ?: '' }}</td></tr>
      @if(!empty($document->accessory_notes))
      <tr><td class="label-cell">Notes</td><td class="colon-cell">:</td><td>{{ $document->accessory_notes }}</td></tr>
      @endif

<div class="modal-header">
  ...
  <h4 class="modal-title"><i class="fa fa-file-text-o text-info"></i> Detail Component <strong>{{ $document->document_number }}</strong>
...
<div class="modal-body doc-detail-modal">
  ...
  <div class="detail-section">
    <h5><i class="fa fa-cube"></i> Component Details</h5>
    <div class="doc-detail-grid">
      <div class="doc-detail-item"><dt>Model</dt><dd>{{ $document->component_model ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Part No</dt><dd>{{ $document->component_part_number ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Serial Number</dt><dd>{{ $document->component_serial_number ?: '' }}</dd></div>
      <div class="doc-detail-item" style="width:100%"><dt>Spec</dt><dd>{{ $document->component_spec ?: '' }}</dd></div>

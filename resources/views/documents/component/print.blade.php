...
<head>
  ...
  /* Default CSS made print-friendly so TCPDF (no media queries) renders well */
...
<body>
  <div class="container">
    ...
    <table class="main-table">
      ...
      <tr><td colspan="3" class="header-row">Component Details</td></tr>
      <tr><td class="label-cell">Model</td><td class="colon-cell">:</td><td>{{ $document->component_model ?: '' }}</td></tr>
      <tr><td class="label-cell">Part No</td><td class="colon-cell">:</td><td>{{ $document->component_part_number ?: '' }}</td></tr>
      <tr><td class="label-cell">Serial Number</td><td class="colon-cell">:</td><td>{{ $document->component_serial_number ?: '' }}</td></tr>
      <tr><td class="label-cell">Spec</td><td class="colon-cell">:</td><td>{{ $document->component_spec ?: '' }}</td></tr>

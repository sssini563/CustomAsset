<div class="modal-header">
  ...
  <h4 class="modal-title"><i class="fa fa-file-text-o text-info"></i> Detail Consumable <strong>{{ $document->document_number }}</strong>
...
<div class="modal-body doc-detail-modal">
  ...
  <div class="detail-section">
    <h5><i class="fa fa-archive"></i> Consumable Details</h5>
    <div class="doc-detail-grid">
      <div class="doc-detail-item"><dt>Batch</dt><dd>{{ $document->consumable_batch ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Qty</dt><dd>{{ $document->consumable_qty ?: '' }}</dd></div>
      <div class="doc-detail-item"><dt>Unit</dt><dd>{{ $document->consumable_unit ?: '' }}</dd></div>
      @if(!empty($document->consumable_notes))
      <div class="doc-detail-item" style="width:100%"><dt>Notes</dt><dd>{{ $document->consumable_notes }}</dd></div>
      @endif

...
<body>
  <div class="container">
    ...
    <table class="main-table">
      ...
      <tr><td colspan="3" class="header-row">Consumable Details</td></tr>
      <tr><td class="label-cell">Batch</td><td class="colon-cell">:</td><td>{{ $document->consumable_batch ?: '' }}</td></tr>
      <tr><td class="label-cell">Qty</td><td class="colon-cell">:</td><td>{{ $document->consumable_qty ?: '' }}</td></tr>
      <tr><td class="label-cell">Unit</td><td class="colon-cell">:</td><td>{{ $document->consumable_unit ?: '' }}</td></tr>
      @if(!empty($document->consumable_notes))
      <tr><td class="label-cell">Notes</td><td class="colon-cell">:</td><td>{{ $document->consumable_notes }}</td></tr>
      @endif

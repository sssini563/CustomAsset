            ...
            <div class="nav-tabs-custom">
                    ...
                    <li>
                        <a href="#software" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.licenses') }}
                                {!! $asset->licenses->count() > 0
                                    ? '<span class="badge badge-secondary">' . number_format($asset->licenses->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#components" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.components') }}
                                {!! $asset->components->count() > 0
                                    ? '<span class="badge badge-secondary">' . number_format($asset->components->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#assets" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $asset->assignedAssets()->count() > 0
                                    ? '<span class="badge badge-secondary">' . number_format($asset->assignedAssets()->count()) . '</span>'
                                    : '' !!}
                        ...
                        <li>
                            <a href="#accessories_assigned" data-toggle="tab" data-tooltip="true">
                                ...
                                <span class="hidden-xs hidden-sm">
                                    ...
                                    {!! $asset->assignedAccessories()->count() > 0
                                        ? '<span class="badge badge-secondary">' . number_format($asset->assignedAccessories()->count()) . '</span>'
                                        : '' !!}
                        ...
                        <li>
                            <a href="#audits" data-toggle="tab" data-tooltip="true">
                                ...
                                <span class="hidden-xs hidden-sm">
                                    ...
                                    {!! $asset->audits()->count() > 0
                                        ? '<span class="badge badge-secondary">' . number_format($asset->audits()->count()) . '</span>'
                                        : '' !!}
                        ...
                        <a href="#maintenances" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.maintenances') }}
                                {!! $asset->maintenances()->count() > 0
                                    ? '<span class="badge badge-secondary">' . number_format($asset->maintenances()->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                        ...
                        <a href="#files" data-toggle="tab">
                            ...
                            <span class="hidden-xs hidden-sm">{{ trans('general.files') }}
                                {!! $asset->uploads->count() > 0
                                    ? '<span class="badge badge-secondary">' . number_format($asset->uploads->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                        ...
                        <li>
                            <a href="#modelfiles" data-toggle="tab">
                                ...
                                <span class="hidden-xs hidden-sm">
                                    ...
                                    {!! $asset->model && $asset->model->uploads->count() > 0
                                        ? '<span class="badge badge-secondary">' . number_format($asset->model->uploads->count()) . '</span>'
                                        : '' !!}
                                </span>
                            </a>
                        </li>
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="info-stack-container">
                                ...
                                <div class="col-md-3 col-xs-12 col-sm-push-9 info-stack">
                                    ...
                                    <div class="col-md-12 text-center">
                                        @if ($asset->image || ($asset->model && $asset->model->image != ''))
                                            <div class="text-center col-md-12" style="padding-bottom: 15px;">
                                                <a href="{{ $asset->getImageUrl() ? $asset->getImageUrl() : null }}"
                                                    data-toggle="lightbox" data-type="image">
                                                    <img src="{{ $asset->getImageUrl() ? $asset->getImageUrl() : null }}"
                                    ...
                                    @if ($asset->deleted_at == '')
                                        @can('update', $asset)
                                            <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                <a href="{{ route('hardware.edit', $asset) }}"
                                                    style="width: 100%; background-color: #3c8dbc !important; border-color: #367fa9 !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                                    class="btn btn-sm btn-warning btn-social btn-block hidden-print">
                                                    <span
                                                        style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;"><x-icon
                                                            type="edit" /></span>
                                                    <span
                                        ...
                                        @if ($asset->assetstatus && $asset->assetstatus->deployable == '1')
                                            @if ($asset->assigned_to != '' && $asset->deleted_at == '')
                                                @can('checkin', $asset)
                                                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                        <span class="tooltip-wrapper"{!! !$asset->model
                                                            ? ' data-tooltip="true" title="' . trans('admin/hardware/general.model_invalid_fix') . '"'
                                                            : '' !!}>
                                                            <a role="button"
                                                                href="{{ route('hardware.checkin.create', $asset->id) }}"
                                                                style="width: 100%; background-color: #00a65a !important; border-color: #008d4c !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                                    ...
                                                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                        <span class="tooltip-wrapper"{!! !$asset->model
                                                            ...
                                                            <a href="{{ route('hardware.checkout.create', $asset->id) }}"
                                                                style="width: 100%; background-color: #f39c12 !important; border-color: #e08e0b !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                        ...
                                        @can('update', \App\Models\Asset::class)
                                            <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                <a href="#"
                                                    style="width: 100%; background-color: #605ca8 !important; border-color: #555299 !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                            ...
                                            <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                <span class="tooltip-wrapper"{!! !$asset->model
                                                    ...
                                                    <a href="{{ route('asset.audit.create', $asset->id) }}"
                                                        style="width: 100%; background-color: #00c0ef !important; border-color: #00acd6 !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                    ...
                                    @can('create', $asset)
                                        <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                            <a href="{{ route('clone/hardware', $asset->id) }}"
                                                style="width: 100%; background-color: #39cccc !important; border-color: #30bbbb !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                                class="btn btn-sm btn-default btn-block btn-social hidden-print">
                                                <span
                                                    style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;"><x-icon
                                                        type="clone" /></span>
                                    ...
                                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                        <form method="POST" action="{{ route('hardware/bulkedit') }}"
                                            accept-charset="UTF-8" class="form-inline" target="_blank" id="bulkForm">
                                            @csrf
                                            <input type="hidden" name="bulk_actions" value="labels" />
                                            <input type="hidden" name="ids[{{ $asset->id }}]"
                                                value="{{ $asset->id }}" />
                                            <button
                                                style="width: 100%; background-color: #b8c7ce !important; border-color: #a7b7c1 !important; color: #444 !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                    ...
                                    @can('delete', $asset)
                                        <div class="col-md-12 hidden-print" style="padding-top: 30px; padding-bottom: 30px;">
                                            ...
                                            @if ($asset->deleted_at == '')
                                                <button
                                                    style="width: 100%; background-color: #dd4b39 !important; border-color: #d73925 !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                                ...
                                <div class="col-md-9 col-xs-12 col-sm-pull-3 info-stack">
                                    ...
                                    <div class="row-new-striped">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <i class="fa-regular fa-clipboard js-copy-link hidden-print"
                                                        ...
                                                        <span
                                                            class="sr-only">{{ trans('general.copy_to_clipboard') }}</span>
                                                    </i>
                                                </div>
                                            </div>
                                        @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    @else
                                                        ...
                                                        @endif
                                                        <a
                                                            href="{{ route('statuslabels.show', $asset->assetstatus->id) }}">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        ...
                                                        @if ($asset->model && $asset->model->manufacturer && $asset->model->manufacturer->url != '')
                                                            <li>
                                                                ...
                                                                <a href="{{ $asset->present()->dynamicUrl($asset->model->manufacturer->url) }}"
                                                                    target="_blank">
                                                        ...
                                                        @if ($asset->model && $asset->model->manufacturer && $asset->model->manufacturer->support_url != '')
                                                            <li>
                                                                ...
                                                                <a href="{{ $asset->present()->dynamicUrl($asset->model->manufacturer->support_url) }}"
                                                                    target="_blank">
                                                        ...
                                                        @if ($asset->model && $asset->model->manufacturer && $asset->model->manufacturer->warranty_lookup_url != '')
                                                            <li>
                                                                ...
                                                                <a href="{{ $asset->present()->dynamicUrl($asset->model->manufacturer->warranty_lookup_url) }}"
                                                                    target="_blank">
                                            ...
                                            <div class="col-md-9">
                                                @if ($asset->model && $asset->model->category)
                                                    @can('view', \App\Models\Category::class)
                                                        <a
                                                            href="{{ route('categories.show', $asset->model->category->id) }}">
                                        ...
                                        <div class="row byod">
                                            ...
                                            <div class="col-md-9">
                                                {!! $asset->byod == '1'
                                                    ? '<i class="fas fa-check text-success" aria-hidden="true"></i> ' . trans('general.yes')
                                                    : '<i class="fas fa-times text-danger" aria-hidden="true"></i> ' . trans('general.no') !!}
                                            </div>
                                        </div>
                                        ...
                                        @if ($asset->model && $asset->model->fieldset)
                                            @foreach ($asset->model->fieldset->fields as $field)
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-md-9{{ $field->format == 'URL' && $asset->{$field->db_column_name()} != '' ? ' ellipsis' : '' }}">
                                                        @if (!empty($asset->{$field->db_column_name()}))
                                                            ...
                                                            @if ($field->field_encrypted == '1' && Gate::allows('assets.view.encrypted_custom_fields'))
                                                                <span
                                                                    class="js-copy-{{ $field->id }} visually-hidden hidden-print"
                                                        ...
                                                        @if (
                                                            ...
                                                            <i class="fas fa-lock" data-tooltip="true"
                                                                data-placement="top"
                                                                title="{{ trans('admin/custom_fields/general.value_encrypted') }}"
                                                                onclick="showHideEncValue(this)"
                                                                id="text-{{ $field->id }}"></i>
                                                        @endif
                                                        ...
                                                        @if ($field->isFieldDecryptable($asset->{$field->db_column_name()}))
                                                            @can('assets.view.encrypted_custom_fields')
                                                                ...
                                                                @if ($fieldSize > 0)
                                                                    <span
                                                                        id="text-{{ $field->id }}-to-hide">***********</span>
                                                                    @if ($field->format == 'URL' && $asset->{$field->db_column_name()} != '')
                                                                        <span
                                                                            class="js-copy-{{ $field->id }} hidden-print"
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    @if ($asset->eol_explicit == '1')
                                                        <span data-tooltip="true" data-placement="top"
                                                            data-title="Explicit EOL" title="Explicit EOL">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><span
                                                    class="line"></span>{{ trans('admin/licenses/form.license_key') }}
                                            </th>
                                            <th><span class="line"></span>{{ trans('admin/licenses/form.expiration') }}
                                            </th>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                                        data-show-columns-search="true" data-cookie-id-table="assetsTable"
                                        data-id-table="assetsTable" data-side-pagination="server" data-sort-order="asc"
                    ...
                    <div class="tab-pane" id="accessories_assigned">
                        ...
                        <div class="table table-responsive">
                            ...
                            <table
                                ...
                                data-id-table="accessoriesAssignedListingTable" data-side-pagination="server"
                                data-sort-order="asc" id="accessoriesAssignedListingTable"
                                class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane fade" id="maintenances">
                        <div class="row{{ $asset->maintenances->count() > 0 ? '' : ' hidden-print' }}">
                            <div class="col-md-12">
                                ...
                                <table data-columns="{{ \App\Presenters\MaintenancesPresenter::dataTableLayout() }}"
                                    class="table table-striped snipe-table" id="MaintenancesTable"
                                    data-buttons="maintenanceButtons" data-id-table="MaintenancesTable"
                                    ...
                                    data-cookie-id-table="MaintenancesTable" data-cookie="true">
                                </table>
                            </div> <!-- /.col-md-12 -->
                        </div> <!-- /.row -->
                    ...
                    <div class="tab-pane fade" id="audits">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped snipe-table" id="assetAuditHistory"
                                    data-id-table="assetAuditHistory" data-side-pagination="server"
                                    data-sort-order="desc" data-sort-name="created_at"
                                    data-export-options='{
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-sm-2" data-field="file" data-sortable="true"
                                                data-visible="false" data-formatter="fileUploadNameFormatter">
                                            ...
                                            <th data-field="log_meta" data-visible="true"
                    ...
                    <div class="tab-pane fade" id="history">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table data-columns="{{ \App\Presenters\HistoryPresenter::dataTableLayout() }}"
                                    class="table table-striped snipe-table" id="assetHistory"
                                    data-id-table="assetHistory" data-side-pagination="server" data-sort-order="desc"
                    ...
                    @if ($asset->model)
                        @can('view', $asset->model)
                            <div class="tab-pane fade" id="modelfiles">
                                <div
                                    class="row{{ $asset->model && $asset->model->uploads->count() > 0 ? '' : ' hidden-print' }}">
                                    <div class="col-md-12">

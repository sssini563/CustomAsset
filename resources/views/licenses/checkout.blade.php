        ...
        <form class="form-horizontal" method="post" action="" autocomplete="off">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="checkout_and_create_document">Dokumen</label>
                        <div class="col-md-8">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="checkout_and_create_document" value="1" />
                                    Checkout &amp; Create Document
                                </label>
                            </div>
                            <p class="help-block small text-muted">Centang untuk menghasilkan dokumen tanda terima &amp; workflow tanda tangan digital.</p>
                        </div>
                    </div>
                </div>

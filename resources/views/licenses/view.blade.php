                ...
                <ul class="nav nav-tabs hidden-print">
                    ...
                    <li>
                        <a href="#seats" data-toggle="tab">
                            ...
                            <span
                                class="badge badge-secondary">{{ number_format($license->assignedCount()->count()) }}</span>
                        ...
                        <li>
                            <a href="#files" data-toggle="tab">
                                ...
                                <span class="hidden-xs hidden-sm">{{ trans('general.file_uploads') }}
                                    {!! $license->uploads->count() > 0
                                        ? '<span class="badge badge-secondary">' . number_format($license->uploads->count()) . '</span>'
                                        : '' !!}
                                </span>
                            </a>
                        </li>
                                ...
                                <div class="container row-new-striped">
                                    ...
                                    @if (!is_null($license->company))
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <a
                                                    href="{{ route('companies.show', $license->company->id) }}">{{ $license->company->name }}</a>
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @if ($license->manufacturer->url)
                                                    <br><x-icon type="globe-us" /> <a
                                                        href="{{ $license->manufacturer->url }}"
                                                        rel="noopener">{{ $license->manufacturer->url }}</a>
                                                @endif

                                                @if ($license->manufacturer->support_url)
                                                    <br><x-icon type="more-info" />
                                                    <a href="{{ $license->manufacturer->support_url }}"
                                                        rel="noopener">{{ $license->manufacturer->support_url }}</a>
                                                @endif

                                                @if ($license->manufacturer->support_phone)
                                                    <br><x-icon type="phone" />
                                                    <a
                                                        href="tel:{{ $license->manufacturer->support_phone }}">{{ $license->manufacturer->support_phone }}</a>
                                                @endif

                                                @if ($license->manufacturer->support_email)
                                                    <br><x-icon type="email" /> <a
                                                        href="mailto:{{ $license->manufacturer->support_email }}">{{ $license->manufacturer->support_email }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <i class="fa-regular fa-clipboard js-copy-link"
                                                    ...
                                                    data-placement="top" title="{{ trans('general.copy_to_clipboard') }}">
                                    ...
                                    @if ($license->category)
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <a
                                                    href="{{ route('categories.show', $license->category->id) }}">{{ $license->category->name }}</a>
                                            </div>
                                        </div>
                                    @endif
                                                ...
                                                @if ($license->supplier->deleted_at == '')
                                                    ...
                                                    @if ($license->supplier->url)
                                                        <br><x-icon type="globe-us" /> <a
                                                            ...
                                                            rel="noopener">{{ $license->supplier->url }}</a>
                                                    @endif

                                                    @if ($license->supplier->phone)
                                                        <br><x-icon type="phone" />
                                                        <a
                                                            href="tel:{{ $license->supplier->phone }}">{{ $license->supplier->phone }}</a>
                                                    @endif

                                                    @if ($license->supplier->email)
                                                        <br><x-icon type="email" /> <a
                                                            href="mailto:{{ $license->supplier->email }}">{{ $license->supplier->email }}</a>
                                                    @endif
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @if ($license->remaincount() <= $license->min_amt - \App\Models\Setting::getSettings()->alert_threshold)
                                                    <span data-tooltip="true"
                                                        title="{{ trans('admin/licenses/general.below_threshold', ['remaining_count' => $license->remaincount(), 'min_amt' => $license->min_amt]) }}"><i
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table data-columns="{{ \App\Presenters\LicensePresenter::dataTableLayoutSeats() }}"
                                        data-cookie-id-table="seatsTable" data-id-table="seatsTable" id="seatsTable"
                                        data-search="false" data-side-pagination="server" data-sort-order="asc"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    <table data-columns="{{ \App\Presenters\LicensePresenter::dataTableLayoutSeats() }}"
                                        data-cookie-id-table="availableSeatsTable" data-id-table="availableSeatsTable"
                                        id="availableSeatsTable" data-search="false" data-side-pagination="server"
                                        data-sort-order="asc" data-sort-name="name"
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table data-columns="{{ \App\Presenters\HistoryPresenter::dataTableLayout() }}"
                                        class="table table-striped snipe-table" data-cookie-id-table="licenseHistoryTable"
                                        data-id-table="licenseHistoryTable" id="licenseHistoryTable"
                                        data-side-pagination="server" data-sort-order="desc"
                                        data-export-options='{
        ...
        <div class="col-md-3">
            ...
            @can('update', $license)
                <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                    <a href="{{ route('licenses.edit', $license->id) }}"
                        ...
                        <span
                            style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                            <x-icon type="edit" />
                        </span>
                ...
                <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                    <a href="{{ route('clone/license', $license->id) }}"
                        style="width: 100%; background-color: #39cccc !important; border-color: #2fb4b4 !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                        class="btn btn-info btn-block btn-sm btn-social hidden-print">
                        <span
                            style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                            <x-icon type="clone" />
                        </span>
            ...
            @can('checkout', $license)
                ...
                @if ($license->availCount()->count() > 0 && !$license->isInactive())
                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                        <a href="{{ route('licenses.checkout', $license->id) }}"
                            ...
                            class="btn bg-maroon btn-sm btn-social btn-block hidden-print">
                            <span
                                style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                    ...
                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                        <a href="#"
                            style="width: 100%; background-color: #f39c12 !important; border-color: #e08e0b !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important;"
                            class="btn bg-maroon btn-sm btn-social btn-block hidden-print" data-toggle="modal"
                            data-tooltip="true"
                            title="{{ trans('admin/licenses/general.bulk.checkout_all.enabled_tooltip') }}"
                ...
                @else
                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                        <span data-tooltip="true"
                            title="{{ $license->availCount()->count() == 0 ? trans('admin/licenses/general.bulk.checkout_all.disabled_tooltip') : trans('admin/licenses/message.checkout.license_is_inactive') }}"
                            style="width: 100%; background-color: #b8c7ce !important; border-color: #a6b4bd !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important; cursor: not-allowed !important; opacity: 0.65 !important;"
                            class="btn bg-maroon btn-sm btn-social btn-block hidden-print disabled">
                            <span
                                style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                                <x-icon type="checkout" />
                            </span>
            ...
            @can('checkin', $license)
                ...
                @if ($license->seats - $license->availCount()->count() <= 0)
                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                        <span data-tooltip="true"
                            title=" {{ trans('admin/licenses/general.bulk.checkin_all.disabled_tooltip') }}"
                            style="width: 100%; background-color: #b8c7ce !important; border-color: #a6b4bd !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important; cursor: not-allowed !important; opacity: 0.65 !important;"
                            class="btn btn-primary bg-purple btn-sm btn-social btn-block hidden-print disabled">
                            <span
                                style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                                <x-icon type="checkin" />
                            </span>
                ...
                @else
                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                        <a href="#"
                            ...
                            class="btn btn-primary bg-purple btn-sm btn-social btn-block hidden-print" data-toggle="modal"
                            data-tooltip="true" data-target="#checkinFromAllModal"
                ...
                @if ($license->availCount()->count() == $license->seats)
                    <div class="col-md-12 hidden-print" style="padding-top: 30px; padding-bottom: 30px;">
                        <button
                            ...
                            class="btn btn-block btn-danger btn-sm btn-social delete-asset" data-icon="fa fa trash"
                            data-toggle="modal" data-title="{{ trans('general.delete') }}"
                            data-content="{{ trans('general.delete_confirm', ['item' => $license->name]) }}"
                            data-target="#dataConfirmModal" onClick="return false;">
                            <span
                                style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                                <x-icon type="delete" />
                            </span>
                ...
                @else
                    <div class="col-md-12 hidden-print" style="padding-top: 30px; padding-bottom: 30px;">
                        <span data-tooltip="true" title=" {{ trans('admin/licenses/general.delete_disabled') }}"
                            style="width: 100%; background-color: #b8c7ce !important; border-color: #a6b4bd !important; color: #fff !important; padding: 6px 10px !important; display: flex !important; align-items: center !important; justify-content: flex-start !important; text-align: left !important; position: relative !important; font-size: 13px !important; cursor: not-allowed !important; opacity: 0.65 !important;"
                            class="btn btn-block btn-danger btn-sm btn-social delete-asset disabled" onClick="return false;">
                            <span
                                style="display: inline-flex !important; align-items: center !important; position: static !important; margin-right: 6px !important; font-size: 12px !important;">
                                <x-icon type="delete" />
                            </span>

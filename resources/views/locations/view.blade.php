        ...
        <div class="col-md-9">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs hidden-print">
                        ...
                        <li class="active">
                            <a href="#users" data-toggle="tab">
                                ...
                                {!! $location->users()->count() > 0
                                    ? '<span class="badge">' . number_format($location->users()->count()) . '</span>'
                                    : '' !!}
                            </a>
                        </li>
                    @endcan
                    ...
                    @can('view', \App\Models\Asset::class)
                        <li>
                            <a href="#assets" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->assets()->AssetsForShow()->count() > 0
                                    ? '<span class="badge">' . number_format($location->assets()->AssetsForShow()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                        ...
                        <li>
                            <a href="#rtd_assets" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->rtd_assets()->AssetsForShow()->count() > 0
                                    ? '<span class="badge">' . number_format($location->rtd_assets()->AssetsForShow()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                        ...
                        <li>
                            <a href="#assets_assigned" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->assignedAssets()->AssetsForShow()->count() > 0
                                    ? '<span class="badge">' . number_format($location->assignedAssets()->AssetsForShow()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                    ...
                    @can('view', \App\Models\Accessory::class)
                        <li>
                            <a href="#accessories" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->accessories()->count() > 0
                                    ? '<span class="badge">' . number_format($location->accessories()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                        ...
                        <li>
                            <a href="#accessories_assigned" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->assignedAccessories()->count() > 0
                                    ? '<span class="badge">' . number_format($location->assignedAccessories()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                    ...
                    @can('view', \App\Models\Consumable::class)
                        <li>
                            <a href="#consumables" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->consumables()->count() > 0
                                    ? '<span class="badge">' . number_format($location->consumables->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                        ...
                        <li>
                            <a href="#components" data-toggle="tab" data-tooltip="true"
                                ...
                                {!! $location->components->count() > 0
                                    ? '<span class="badge">' . number_format($location->components()->count()) . '</span>'
                                    : '' !!}
                                <span class="sr-only">
                    ...
                    <li>
                        <a href="#child_locations" data-toggle="tab" data-tooltip="true"
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->children()->count() > 0
                                    ? '<span class="badge">' . number_format($location->children()->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="#files" data-toggle="tab" data-tooltip="true" title="{{ trans('general.files') }}">
                            ...
                            <span class="hidden-xs hidden-sm">
                                ...
                                {!! $location->uploads()->count() > 0
                                    ? '<span class="badge">' . number_format($location->uploads()->count()) . '</span>'
                                    : '' !!}
                            </span>
                        </a>
                    </li>
                ...
                <div class="tab-content">
                    @can('view', \App\Models\User::class)
                        ...
                        <table data-columns="{{ \App\Presenters\UserPresenter::dataTableLayout() }}"
                            data-cookie-id-table="usersTable" data-id-table="usersTable" data-side-pagination="server"
                            data-sort-order="asc" data-toolbar="#userBulkEditToolbar"
                            data-bulk-button-id="#bulkUserEditButton" data-bulk-form-id="#usersBulkForm" id="usersTable"
                            data-buttons="userButtons" class="table table-striped snipe-table"
                    ...
                    <div id="assets" @class(['tab-pane'])>
                        ...
                        <table data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            data-show-columns-search="true" data-cookie-id-table="assetsListingTable"
                            data-id-table="assetsListingTable" data-side-pagination="server" data-sort-order="asc"
                            data-toolbar="#assetsBulkEditToolbar" data-bulk-button-id="#bulkAssetEditButton"
                            data-bulk-form-id="#assetsBulkForm" id="assetsListingTable" data-buttons="assetButtons"
                    ...
                    <div class="tab-pane" id="assets_assigned">
                        ...
                        <table role="table" data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            data-show-columns-search="true" data-cookie-id-table="assetsAssignedListingTable"
                            data-id-table="assetsAssignedListingTable" data-side-pagination="server"
                            data-sort-order="asc" data-toolbar="#AssignedAssetsBulkEditToolbar"
                            data-bulk-button-id="#AssignedbulkAssetEditButton" data-bulk-form-id="#assignedAssetsBulkForm"
                            id="assetsAssignedListingTable" data-buttons="assetButtons"
                            class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="rtd_assets">
                        ...
                        @include('partials.asset-bulk-actions', [
                            'id_divname' => 'RTDassetsBulkEditToolbar',
                            'id_formname' => 'RTDassets',
                            'id_button' => 'RTDbulkAssetEditButton',
                        ])
                        <table role="table" data-columns="{{ \App\Presenters\AssetPresenter::dataTableLayout() }}"
                            data-show-columns-search="true" data-cookie-id-table="RTDassetsListingTable"
                            data-id-table="RTDassetsListingTable" data-side-pagination="server" data-sort-order="asc"
                            data-toolbar="#RTDassetsBulkEditToolbar" data-bulk-button-id="#RTDbulkAssetEditButton"
                            data-bulk-form-id="#RTDassetsBulkEditToolbar" id="RTDassetsListingTable"
                            data-buttons="assetButtons" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="accessories">
                        ...
                        <table role="table" data-columns="{{ \App\Presenters\AccessoryPresenter::dataTableLayout() }}"
                            data-cookie-id-table="accessoriesListingTable" data-id-table="accessoriesListingTable"
                            data-side-pagination="server" data-sort-order="asc" id="accessoriesListingTable"
                            data-buttons="accessoryButtons" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="accessories_assigned">
                        ...
                        <table role="table"
                            ...
                            data-sort-order="asc" id="accessoriesAssignedListingTable" data-buttons="accessoryButtons"
                            class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="consumables">
                        ...
                        <table role="table" data-columns="{{ \App\Presenters\ConsumablePresenter::dataTableLayout() }}"
                            data-cookie-id-table="consumablesListingTable" data-id-table="consumablesListingTable"
                            data-side-pagination="server" data-sort-order="asc" id="consumablesListingTable"
                            data-buttons="consumableButtons" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="components">
                        ...
                        <table role="table" data-columns="{{ \App\Presenters\ComponentPresenter::dataTableLayout() }}"
                            data-cookie-id-table="componentsTable" data-id-table="componentsTable"
                            data-side-pagination="server" data-sort-order="asc" id="componentsTable"
                            data-buttons="componentButtons" class="table table-striped snipe-table"
                    ...
                    <div class="tab-pane" id="child_locations">
                        ...
                        <table role="table" data-columns="{{ \App\Presenters\LocationPresenter::dataTableLayout() }}"
                            data-cookie-id-table="childrenListingTable" data-id-table="childrenListingTable"
                            data-side-pagination="server" data-sort-order="asc" id="childrenListingTable"
                            data-buttons="childrenListingTable" class="table table-striped snipe-table"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table data-columns="{{ \App\Presenters\HistoryPresenter::dataTableLayout() }}"
                                    class="table table-striped snipe-table" id="locationHistory"
                                    data-id-table="locationHistory" data-side-pagination="server" data-sort-order="desc"
                                    ...
                                    data-cookie-id-table="locationHistory" data-cookie="true">
                                </table>
                            </div>
                        </div> <!-- /.row -->
        ...
        <div class="col-md-3">
                    ...
                    @if (($location->address != '' && $location->city != '') || $location->state != '' || $location->country != '')
                        <li>
                            <a href="https://maps.google.com/?q={{ urlencode($location->address . ',' . $location->city . ',' . $location->state . ',' . $location->country . ',' . $location->zip) }}"
                                target="_blank">
                                {!! trans('admin/locations/message.open_map', [
                                    'map_provider_icon' => '<i class="fa-brands fa-google" aria-hidden="true"></i>',
                                ]) !!}
                        ...
                        <li>
                            <a href="https://maps.apple.com/?q={{ urlencode($location->address . ',' . $location->city . ',' . $location->state . ',' . $location->country . ',' . $location->zip) }}"
                                target="_blank">
                                {!! trans('admin/locations/message.open_map', [
                                    'map_provider_icon' => '<i class="fa-brands fa-apple" aria-hidden="true" style="font-size: 18px"></i>',
                                ]) !!}
            ...
            @if ($location->deleted_at == '')
                <div class="col-md-12" style="padding-top: 5px;">
                    <a href="{{ route('locations.print_assigned', ['locationId' => $location->id]) }}"
                ...
                <div class="col-md-12" style="padding-top: 5px;">
                    <a href="{{ route('locations.print_all_assigned', ['locationId' => $location->id]) }}"
                        class="btn btn-block btn-sm btn-primary btn-social hidden-print">
                        <x-icon type="print" />
                ...
                <div class="col-md-12 hidden-print" style="padding-top: 10px;">
                    ...
                    @if ($location->deleted_at == '')
                        @if ($location->isDeletable())
                            <button class="btn btn-sm btn-block btn-danger btn-social delete-asset" data-toggle="modal"
                        ...
                        @else
                            <span data-placement="top" data-tooltip="true"
                                data-title="{{ trans('admin/locations/message.assoc_users') }}">
                                <a href="#" class="btn btn-block btn-sm btn-danger btn-social hidden-print disabled"
                                    data-tooltip="true">
                                    <x-icon type="delete" />
                                    {{ trans('general.delete') }}
                                </a>

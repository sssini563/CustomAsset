...
@section('content')
    ...
    <form method="POST" action="{{ route('settings.branding.save') }}" accept-charset="UTF-8" autocomplete="off"
        class="form-horizontal" role="form" id="create-form" enctype="multipart/form-data" novalidate="novalidate">
        <!-- CSRF Token -->
        {{ csrf_field() }}
                ...
                <div class="panel box box-default">
                        ...
                        <div class="col-md-12">
                            ...
                            <fieldset name="logo-preferences" class="bottom-padded">
                                    ...
                                    <div class="col-md-7 required">
                                        @if (config('app.lock_passwords') === true)
                                            <input class="form-control" disabled="disabled"
                                                placeholder="Snipe-IT Asset Management" name="site_name" type="text"
                                                value="{{ old('site_name', $setting->site_name) }}" id="site_name">
                                            <p class="text-warning">
                                                <x-icon type="locked" />
                                                {{ trans('general.feature_disabled') }}
                                            </p>
                                        @else
                                            <input class="form-control" placeholder="Snipe-IT Asset Management"
                                                required="required" name="site_name" type="text"
                                                value="{{ old('site_name', $setting->site_name) }}" id="site_name">
                                        @endif
                                ...
                                @include('partials/forms/edit/uploadLogo', [
                                    ...
                                    'helpBlock' =>
                                        ...
                                        trans('general.image_filetypes_help', [
                                            'size' => Helper::file_upload_max_size_readable(),
                                        ]),
                                ])
                                ...
                                @include('partials/forms/edit/uploadLogo', [
                                    ...
                                    'helpBlock' => trans('general.image_filetypes_help', [
                                        'size' => Helper::file_upload_max_size_readable(),
                                    ]),
                                ])
                                ...
                                <!-- Login Background -->
                                @include('partials/forms/edit/uploadLogo', [
                                    'logoVariable' => 'login_background',
                                    'logoId' => 'uploadLoginBackground',
                                    'logoLabel' => 'Login Background',
                                    'logoClearVariable' => 'clear_login_background',
                                    'helpBlock' => trans('general.image_filetypes_help', [
                                        'size' => Helper::file_upload_max_size_readable(),
                                    ]),
                                ])
                                ...
                                @include('partials/forms/edit/uploadLogo', [
                                    ...
                                    'helpBlock' =>
                                        trans('admin/settings/general.favicon_size') .
                                        ' ' .
                                        trans('admin/settings/general.favicon_format'),
                                    'allowedTypes' =>
                                        'image/x-icon,image/gif,image/jpeg,image/png,image/svg,image/svg+xml,image/vnd.microsoft.icon',
                                    'maxSize' => 20000,
                                ])
                                ...
                                @include('partials/forms/edit/uploadLogo', [
                                    ...
                                    'logoPath' => 'avatars/',
                                    'helpBlock' =>
                                        trans('admin/settings/general.default_avatar_help') .
                                        ' ' .
                                        trans('general.image_filetypes_help', [
                                            'size' => Helper::file_upload_max_size_readable(),
                                        ]),
                                ...
                                @if (
                                    $setting->default_avatar == '' ||
                                        ($setting->default_avatar == 'default.png' && Storage::disk('public')->missing('default.png')))
                                    <!-- Restore Default Avatar -->
                                    <div class="form-group">

                                        <div class="col-md-9 col-md-offset-3">
                                            <label class="form-control">
                                                <input type="checkbox" name="restore_default_avatar" value="1"
                                                    @checked(old('restore_default_avatar', $setting->restore_default_avatar)) />
                                                <span>{!! trans('admin/settings/general.restore_default_avatar', [
                                                    'default_avatar' => Storage::disk('public')->url('default.png'),
                                                ]) !!}</span>
                                            </label>
                                            <p class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('load_remote') ? 'error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-control">
                                            <input type="checkbox" name="load_remote" value="1"
                                                @checked(old('load_remote', $setting->load_remote)) />
                                            {{ trans('general.yes') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-control">
                                            <input type="checkbox" name="logo_print_assets" value="1"
                                                @checked(old('logo_print_assets', $setting->logo_print_assets)) aria-label="logo_print_assets" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-control">
                                            <input type="checkbox" name="show_url_in_emails" value="1"
                                                @checked(old('show_url_in_emails', $setting->show_url_in_emails)) aria-label="show_url_in_emails" />
                                            {{ trans('general.yes') }}
                                        </label>
                                        <p class="help-block">
                                            {{ trans('admin/settings/general.show_url_in_emails_help_text') }}</p>
                                    </div>
                                </div>
                            </fieldset>
                            <!-- colors and skins -->
                            ...
                            <fieldset name="color-preferences" class="bottom-padded">
                                ...
                                <div class="form-group {{ $errors->has('header_color') ? 'error' : '' }}">
                                    <div class="col-md-3">
                                        <label
                                            for="header_color">{{ trans('admin/settings/general.header_color') }}</label>
                                    </div>
                                    <div class="col-md-5 col-xs-5 col-sm-3 col-md-4 col-lg-3 col-xl-3">
                                        <div class="input-group header-color">
                                            <input class="form-control" placeholder="#FF0000" aria-label="header_color"
                                                name="header_color" type="text" id="header_color"
                                                value="{{ old('header_color', $setting->header_color ?? '#3c8dbc') }}">
                                            <div class="input-group-addon">
                                                <i class="fa-solid fa-square"
                                                    style="color: {{ old('header_color', $setting->header_color ?? '#3c8dbc') }}"></i>
                                            </div>
                                        </div><!-- /.input group -->
                                ...
                                <div class="form-group {{ $errors->has('skin') ? 'error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <p class="help-block">{{ trans('admin/settings/general.skin_help') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group {{ $errors->has('custom_css') ? 'error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        @if (config('app.lock_passwords') === true)
                                            <x-input.textarea name="custom_css" :value="old('custom_css', $setting->custom_css)"
                                                placeholder="{{ trans('admin/settings/general.custom_css_placeholder') }}"
                                                aria-label="custom_css" disabled />
                                ...
                                <!-- Allow User Skin -->
                                <div class="form-group {{ $errors->has('allow_user_skin') ? 'error' : '' }}">
                                    <div class="col-md-3">
                                        <strong>{{ trans('admin/settings/general.allow_user_skin') }}</strong>
                                    </div>
                                    <div class="col-md-9">
                                        <label class="form-control">
                                            <input type="checkbox" name="allow_user_skin" value="1"
                                                @checked(old('allow_user_skin', $setting->allow_user_skin)) />
                                            {{ trans('general.yes') }}
                                        </label>
                                        {!! $errors->first('allow_user_skin', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                                        <p class="help-block">{{ trans('admin/settings/general.allow_user_skin_help') }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <fieldset name="footer-preferences" class="bottom-padded">
                                ...
                                <div class="form-group {{ $errors->has('support_footer') ? 'error' : '' }}">
                                    <div class="col-md-3">
                                        <label
                                            for="support_footer">{{ trans('admin/settings/general.support_footer') }}</label>
                                    </div>
                                    <div class="col-md-9">
                                        @if (config('app.lock_passwords') === true)
                                            <x-input.select name="support_footer" id="support_footer" :options="[
                                                'on' => trans('admin/settings/general.enabled'),
                                                'off' => trans('admin/settings/general.two_factor_disabled'),
                                                'admin' => trans('admin/settings/general.super_admin_only'),
                                            ]"
                                                :selected="old('support_footer', $setting->support_footer)" disabled class="form-control disabled"
                                                style="width: 150px" />
                                            <p class="text-warning"><i class="fas fa-lock"></i>
                                                {{ trans('general.feature_disabled') }}</p>
                                        @else
                                            <x-input.select name="support_footer" id="support_footer" :options="[
                                                ...
                                                :selected="old('support_footer', $setting->support_footer)" class="form-control" style="width: 150px" />
                                        @endif
                                ...
                                <div class="form-group {{ $errors->has('version_footer') ? 'error' : '' }}">
                                    <div class="col-md-3">
                                        <label
                                            for="version_footer">{{ trans('admin/settings/general.version_footer') }}</label>
                                    </div>
                                    <div class="col-md-9">
                                        @if (config('app.lock_passwords') === true)
                                            <x-input.select name="version_footer" id="version_footer" :options="[
                                                'on' => trans('admin/settings/general.enabled'),
                                                'off' => trans('admin/settings/general.two_factor_disabled'),
                                                'admin' => trans('admin/settings/general.super_admin_only'),
                                            ]"
                                                :selected="old('version_footer', $setting->version_footer)" disabled class="form-control disabled"
                                                style="width: 150px" />
                                            <p class="text-warning"><i class="fas fa-lock"></i>
                                                {{ trans('general.feature_disabled') }}</p>
                                        @else
                                            <x-input.select name="version_footer" id="version_footer" :options="[
                                                ...
                                                :selected="old('version_footer', $setting->version_footer)" class="form-control" style="width: 150px" />
                                        @endif

                                        <p class="help-block">{{ trans('admin/settings/general.version_footer_help') }}
                                        </p>
                                ...
                                <div class="form-group {{ $errors->has('footer_text') ? 'error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        @if (config('app.lock_passwords') === true)
                                            <x-input.textarea name="footer_text" :value="old('footer_text', $setting->footer_text)" rows="4"
                    ...
                    <div class="box-footer">
                        ...
                        <div class="text-right col-md-6">
                            <button type="submit" class="btn btn-primary"><x-icon type="checkmark" />

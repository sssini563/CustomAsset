               ...
               <div class="box-body">
                   ...
                   <div class="col-md-12">
                       ...
                       <fieldset class="bottom-padded">
                           ...
                           <!-- Document public token expiry (days) -->
                           <div class="form-group {{ $errors->has('document_public_token_days') ? 'error' : '' }}">
                               <div class="col-md-3">
                                   <label for="document_public_token_days">Public token expiry (days)</label>
                               </div>
                               <div class="col-md-8">
                                   <input class="form-control" style="max-width: 120px;" placeholder="14" min="0" name="document_public_token_days" type="number" value="{{ old('document_public_token_days', $setting->document_public_token_days ?? config('documents.public_token_days')) }}" id="document_public_token_days">
                                   <span class="help-block">0 means no expiry. If left blank, defaults to .env DOCUMENT_PUBLIC_TOKEN_DAYS ({{ config('documents.public_token_days') }} days).</span>
                                   {!! $errors->first('document_public_token_days', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                               </div>
                           </div>

...
@section('header_right')
    ...
    <div class="pull-right">
        ...
        <form onsubmit="return false;" role="search" aria-label="Admin Options" id="setting-search">
            <div class="btn-group">
                <input id="searchinput" name="search" type="search" class="search form-control"
                    placeholder="{{ trans('admin/settings/general.filter_by_keyword') }}" aria-label="keyword search">
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.branding.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true"
                                    style="display:none">{{ trans('admin/settings/general.keywords.brand') }}</span>
                            </a>
                        </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.general.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true"
                                    style="display:none">{{ trans('admin/settings/general.keywords.general_settings') }}</span>
                            </a>
                        </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.security.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true"
                                    style="display:none">{{ trans('admin/settings/general.keywords.security') }}</span>
                            </a>
                        </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('groups.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true" style="display:none">
                                    {{ trans('admin/settings/general.keywords.groups') }}</span>
                            </a>
                        </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.localization.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true" style="display:none">
                                    {{ trans('admin/settings/general.keywords.localization') }}</span>
                            </a>
                        </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.alerts.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true" style="display:none">
                                    {{ trans('admin/settings/general.keywords.notifications') }}</span>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.labels.index') }}" class="settings_button">
                                ...
                                <span class="keywords" aria-hidden="true" style="display:none">
                                    {{ trans('admin/settings/general.keywords.labels') }}</span>
                            </a>
                        </h5>
                        ...
                        <div class="box-body text-center">
                            <h5>
                                <a href="{{ route('settings.phpinfo.index') }}" class="settings_button">
                                    ...
                                    <span class="keywords" aria-hidden="true"
                                        style="display:none">{{ trans('admin/settings/general.keywords.php_overview') }}</span>
                                </a>
                            </h5>
                    ...
                    <div class="box-body text-center">
                        <h5>
                            <a href="{{ route('settings.purge.index') }}" class="link-danger">
                                ...
                                <span class="keywords" aria-hidden="true"
                                    style="display:none">{{ trans('admin/settings/general.keywords.purge') }}</span>
                            </a>
                        </h5>
                        ...
                        <div class="row row-new-striped" style="line-height: 23px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="padding-top: 3px; padding-bottom: 3px;">
                                    {{ config('version.app_version') }} build {{ config('version.build_version') }}

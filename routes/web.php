...
Route::group(['middleware' => 'auth', 'prefix' => 'documents'], function () {
    ...
    Route::get('{document}/pdf', [\App\Http\Controllers\Documents\DocumentController::class,'pdf'])->name('documents.pdf');
    Route::get('{document}/edit', [\App\Http\Controllers\Documents\DocumentController::class,'edit'])->name('documents.edit');
    Route::post('{document}/update', [\App\Http\Controllers\Documents\DocumentController::class,'update'])->name('documents.update');
    Route::post('{document}/sign/{role}', [\App\Http\Controllers\Documents\DocumentSignatureController::class,'sign'])->name('documents.sign');
    Route::post('{document}/reject/{role}', [\App\Http\Controllers\Documents\DocumentSignatureController::class,'reject'])->name('documents.reject');
    // Signature deep-link page and actions
    Route::get('{document}/sign-page/{role}', [\App\Http\Controllers\Documents\DocumentController::class,'signPage'])->name('documents.sign.page');
    Route::post('{document}/signature/{role}/send-link', [\App\Http\Controllers\Documents\DocumentController::class,'sendSignatureLink'])->name('documents.signature.send_link');
    Route::post('{document}/signature/{role}/cancel', [\App\Http\Controllers\Documents\DocumentController::class,'cancelSignature'])->name('documents.signature.cancel');
    Route::post('{document}/signature/{role}/copied-link', [\App\Http\Controllers\Documents\DocumentController::class,'copiedSignatureLink'])->name('documents.signature.copied_link');
    Route::post('{document}/signature/{role}/regenerate-token', [\App\Http\Controllers\Documents\DocumentController::class,'regenerateSignatureToken'])->name('documents.signature.regenerate_token');
    Route::post('{document}/signature/{role}/disable-token', [\App\Http\Controllers\Documents\DocumentController::class,'disableSignatureToken'])->name('documents.signature.disable_token');
    // Complete (lock) document
    Route::post('{document}/complete', [\App\Http\Controllers\Documents\DocumentController::class,'complete'])->name('documents.complete');
    Route::post('{document}/recompute', [\App\Http\Controllers\Documents\DocumentController::class,'recompute'])->name('documents.recompute');
    Route::post('{document}/regen-number', [\App\Http\Controllers\Documents\DocumentController::class,'regenNumber'])->name('documents.regenNumber');
    Route::post('{document}/update-signature-people', [\App\Http\Controllers\Documents\DocumentController::class,'updateSignaturePeople'])->name('documents.updateSignaturePeople');
    // QR image endpoint (SVG)
    Route::get('{document}/qr/{role}.svg', [\App\Http\Controllers\Documents\DocumentController::class,'qrSvg'])->name('documents.qr.svg');
    // Modal/interactive routes
    Route::get('{document}/modal-detail', [\App\Http\Controllers\Documents\DocumentController::class,'modalDetail'])->name('documents.modal.detail');
    Route::get('{document}/modal-approval', [\App\Http\Controllers\Documents\DocumentController::class,'modalApproval'])->name('documents.modal.approval');
    // Global cancel approval removed per request (use per-signature cancel)
    // Route::post('{document}/cancel-approval', [\App\Http\Controllers\Documents\DocumentController::class,'cancelApproval'])->name('documents.cancel.approval');
    Route::delete('{document}', [\App\Http\Controllers\Documents\DocumentController::class,'destroy'])->name('documents.destroy');
});

// Public approval routes (no auth required)
Route::group(['prefix' => 'public/documents'], function(){
    Route::get('approval/{token}', [\App\Http\Controllers\Documents\PublicApprovalController::class, 'show'])->name('public.documents.approval.show');
    Route::post('approval/{token}/approve', [\App\Http\Controllers\Documents\PublicApprovalController::class, 'approve'])->name('public.documents.approval.approve');
    Route::post('approval/{token}/reject', [\App\Http\Controllers\Documents\PublicApprovalController::class, 'reject'])->name('public.documents.approval.reject');
});

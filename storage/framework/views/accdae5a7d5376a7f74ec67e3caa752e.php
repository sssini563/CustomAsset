            ...
            $('.snipe-table').bootstrapTable('destroy').each(function() {
                ...
                $(this).bootstrapTable({
                    ...
                    pageList: ['10', '20', '30', '50', '100', '150', '200'
                        <?php echo config('app.max_results') > 200 ? ",'500'" : ''; ?><?php echo config('app.max_results') > 500 ? ",'" . config('app.max_results') . "'" : ''; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'spinner']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> <?php echo e(trans('general.loading')); ?> </h2>';
        ...
        window.userButtons = () => ({
            ...
            btnShowAdmins: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(request()->input('admins') == 'true' ? route('users.index') : route('users.index', ['admins' => 'true'])); ?>';
                },
                attributes: {
            ...
            btnShowDeleted: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(request()->input('status') == 'deleted' ? route('users.index') : route('users.index', ['status' => 'deleted'])); ?>';
                },
                attributes: {
        ...
        window.assetButtons = () => ({
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', \App\Models\Asset::class)): ?>
                btnAddMaintenance: {
                    ...
                    event() {
                        window.location.href =
                            '<?php echo e(route('maintenances.create', ['asset_id' => isset($asset) ? $asset->id : ''])); ?>';
                    },
                    attributes: {
            ...
            btnShowDeleted: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(request()->input('status') == 'Deleted' ? route('hardware.index') : route('hardware.index', ['status' => 'Deleted'])); ?>';
                },
                attributes: {
                    class: '<?php echo e(request()->input('status') == 'Deleted' ? ' btn-danger' : ''); ?>',
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\Location::class)): ?>
            ...
            window.locationButtons = () => ({
                ...
                btnShowDeleted: {
                    ...
                    event() {
                        window.location.href =
                            '<?php echo e(request()->input('status') == 'deleted' ? route('locations.index') : route('locations.index', ['status' => 'deleted'])); ?>';
                    },
                    attributes: {
                        title: '<?php echo e(request()->input('status') == 'deleted' ? trans('admin/users/table.show_current') : trans('admin/users/table.show_deleted')); ?>',
            ...
            window.manufacturerButtons = () => ({
                btnAdd: {
                    ...
                    btnShowDeleted: {
                        ...
                        event() {
                            window.location.href =
                                '<?php echo e(request()->input('status') == 'deleted' ? route('manufacturers.index') : route('manufacturers.index', ['status' => 'deleted'])); ?>';
                        },
                        attributes: {
                            class: '<?php echo e(request()->input('status') == 'Deleted' ? ' btn-danger' : ''); ?>',
                            title: '<?php echo e(request()->input('status') == 'Deleted' ? trans('general.list_all') : trans('general.deleted')); ?>',
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', \App\Models\AssetModel::class)): ?>
            ...
            window.modelButtons = () => ({
                ...
                btnShowDeleted: {
                    ...
                    event() {
                        window.location.href =
                            '<?php echo e(request()->input('status') == 'deleted' ? route('models.index') : route('models.index', ['status' => 'deleted'])); ?>';
                    },
                    attributes: {
                        class: '<?php echo e(request()->input('status') == 'deleted' ? ' btn-danger' : ''); ?>',
                        title: '<?php echo e(request()->input('status') == 'deleted' ? trans('general.list_all') : trans('general.deleted')); ?>',
        ...
        window.licenseButtons = () => ({
            ...
            btnExport: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(route('licenses.export', ['category_id' => isset($category) ? $category->id : ''])); ?>';
                },
                attributes: {
                    class: 'btn-primary',
                    title: '<?php echo e(trans('general.export_all_to_csv')); ?>',
            ...
            btnShowExpiring: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(request()->input('status') == 'expiring' ? route('licenses.index') : route('licenses.index', ['status' => 'expiring'])); ?>';
                },
                attributes: {
            ...
            btnShowInactive: {
                ...
                event() {
                    window.location.href =
                        '<?php echo e(request()->input('status') == 'inactive' ? route('licenses.index') : route('licenses.index', ['status' => 'inactive'])); ?>';
                },
                attributes: {
        ...
        function dateRowCheckStyle(value) {
            if ((value.days_to_next_audit) && (value.days_to_next_audit <
                    <?php echo e($snipeSettings->audit_warning_days ?: 0); ?>)) {
                return {
                    classes: "danger"
                }
            }
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'superadmin','title' => ''.e(trans('general.superuser')).'','class' => 'text-danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?> <a href="<?php echo e(config('app.url')); ?>/users/' +
                        row.id + '">' + value + '</a></span>';
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'superadmin','title' => ''.e(trans('general.admin_user')).'','class' => 'text-warning']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?> <a href="<?php echo e(config('app.url')); ?>/users/' +
        ...
        function genericColumnObjLinkFormatter(destination) {
            return function(value, row) {
                if ((value) && (value.status_meta)) {
                    ...
                    return '<nobr><a href="<?php echo e(config('app.url')); ?>/' + destination + '/' + value.id +
                    ...
                    return '<nobr><a href="<?php echo e(config('app.url')); ?>/' + polymorphicItemFormatterDest + dest + '/' +
        ...
        function licenseKeyFormatter(value, row) {
            if (value) {
                return '<code class="single-line"><span class="js-copy-link" data-clipboard-target=".js-copy-key-' + row
                    .id +
                    '" aria-hidden="true" data-tooltip="true" data-placement="top" title="<?php echo e(trans('general.copy_to_clipboard')); ?>"><span class="js-copy-key-' +
        ...
        function hardwareAuditFormatter(value, row) {
            return '<a href="<?php echo e(config('app.url')); ?>/hardware/' + row.id +
                '/audit" class="actions btn btn-sm btn-primary" style="background-color:#27ae60 !important;border-color:#27ae60 !important;" data-tooltip="true" title="<?php echo e(trans('general.audit')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
            ...
            return function(value, row) {
                ...
                if ((row.available_actions) && (row.available_actions.clone === true)) {
                    actions += '<a href="<?php echo e(config('app.url')); ?>/' + dest + '/' + row.id +
                        '/clone" class="actions btn btn-sm btn-info" style="background-color:#5dade2 !important;border-color:#5dade2 !important;" data-tooltip="true" title="<?php echo e(trans('general.clone_item')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.audit')); ?></span></a>&nbsp;';
                ...
                if ((row.available_actions) && (row.available_actions.update === true)) {
                    actions += '<a href="<?php echo e(config('app.url')); ?>/' + dest + '/' + row.id +
                        '/edit" class="actions btn btn-sm btn-warning" style="background-color:#f39c12 !important;border-color:#f39c12 !important;" data-tooltip="true" title="<?php echo e(trans('general.update')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.update')); ?></span></a>&nbsp;';
                    ...
                    if ((row.available_actions) && (row.available_actions.update != true)) {
                        actions +=
                            '<span data-tooltip="true" title="<?php echo e(trans('general.cannot_be_edited')); ?>"><a class="btn btn-warning btn-sm disabled" onClick="return false;"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'edit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></a></span>&nbsp;';
                ...
                if ((row.available_actions) && (row.available_actions.delete === true)) {
                    ...
                    actions += '<a href="<?php echo e(config('app.url')); ?>/' + dest + '/' + row.id + '" ' +
                        ' class="actions btn btn-danger btn-sm delete-asset" style="background-color:#EF5350 !important;border-color:#EF5350 !important;" data-tooltip="true"  ' +
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.delete')); ?></span></a>&nbsp;';
                    ...
                    if ((row.available_actions) && (row.available_actions.restore != true)) {
                        actions +=
                            '<span data-tooltip="true" title="<?php echo e(trans('general.cannot_be_deleted')); ?>"><a class="btn btn-danger btn-sm delete-asset disabled" onClick="return false;"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'delete']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.cannot_be_deleted')); ?></span></a></span>&nbsp;';
                ...
                if ((row.available_actions) && (row.available_actions.restore === true)) {
                    actions += '<form style="display: inline;" method="POST" action="<?php echo e(config('app.url')); ?>/' +
                        dest + '/' + row.id + '/restore"> ';
                    actions += '<?php echo csrf_field(); ?>';
                    actions +=
                        '<button class="btn btn-sm btn-warning" data-tooltip="true" title="<?php echo e(trans('general.restore')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?><span class="sr-only"><?php echo e(trans('general.restore')); ?></span></button>&nbsp;';
        ...
        function polymorphicItemFormatter(value) {
            ...
            if ((value) && (value.type)) {
                ...
                return '<nobr><a href="<?php echo e(config('app.url')); ?>/' + item_destination + '/' + value.id +
                    '" data-tooltip="true" title="' + value.type + '"><i class="' + item_icon +
                    ' text-<?php echo e($snipeSettings->skin != '' ? $snipeSettings->skin : 'blue'); ?> "></i> ' + value.name +
                    '</a></nobr>';
        ...
        function licenseInOutFormatter(value, row) {
            ...
            if (row.user_can_checkout === false) {
                ...
                if ((row.available_actions.checkout === true) && (row.user_can_checkout === true) && (row.disabled ===
                        false)) {
                    return '<a href="<?php echo e(config('app.url')); ?>/licenses/' + row.id +
                        '/checkout/" class="btn btn-sm bg-maroon" data-tooltip="true" title="<?php echo e(trans('general.checkout_tooltip')); ?>"><?php echo e(trans('general.checkout')); ?></a>';
                }
        }
        ...
        function licenseSeatInOutFormatter(value, row) {
            if (row.disabled && (row.assigned_user || row.assigned_asset)) {
                return '<a href="<?php echo e(config('app.url')); ?>/licenses/' + row.id +
                    '/checkin" class="btn btn-sm bg-purple" data-tooltip="true" title="<?php echo e(trans('general.checkin_tooltip')); ?>"><?php echo e(trans('general.checkin')); ?></a>';
            }
            if (row.disabled) {
                return '<a href="<?php echo e(config('app.url')); ?>/licenses/' + row.id +
                    '/checkin" class="btn btn-sm bg-maroon disabled" data-tooltip="true" title="<?php echo e(trans('general.checkin_tooltip')); ?>"><?php echo e(trans('general.checkout')); ?></a>';
            }
            // The user is allowed to check the license seat out and it's available
            if ((row.available_actions.checkout === true) && (row.user_can_checkout === true) && ((!row.assigned_asset) && (
                    !row.assigned_user))) {
                return '<a href="<?php echo e(config('app.url')); ?>/licenses/' + row.license_id + '/checkout/' + row.id +
                    '" class="btn btn-sm bg-maroon" data-tooltip="true" title="<?php echo e(trans('general.checkout_tooltip')); ?>"><?php echo e(trans('general.checkout')); ?></a>';
            }
        ...
        function genericCheckinCheckoutFormatter(destination) {
            return function(value, row) {
                ...
                if ((row.available_actions.checkout == true) && (row.user_can_checkout == true) && ((!row.asset_id) && (
                    ...
                    return '<a href="<?php echo e(config('app.url')); ?>/' + destination + '/' + row.id +
                        '/checkout" class="btn btn-sm bg-maroon" data-tooltip="true" title="<?php echo e(trans('general.checkout_tooltip')); ?>"><?php echo e(trans('general.checkout')); ?></a>';
                    ...
                    if (row.assigned_to) {
                        ...
                        return '<a href="<?php echo e(config('app.url')); ?>/' + destination + '/' + row.assigned_pivot_id +
                            '/checkin" class="btn btn-sm bg-purple" data-tooltip="true" title="<?php echo e(trans('general.checkin_tooltip')); ?>"><?php echo e(trans('general.checkin')); ?></a>';
                    }
        ...
        function assetRequestActionsFormatter(row, value) {
            if (value.assigned_to_self == true) {
                ...
                return '<form action="<?php echo e(config('app.url')); ?>/account/request-asset/' + value.id +
                    '/cancel" method="POST"><?php echo csrf_field(); ?><button class="btn btn-danger btn-block btn-sm" data-tooltip="true" title="<?php echo e(trans('admin/hardware/message.requests.cancel')); ?>"><?php echo e(trans('button.cancel')); ?></button></form>';
            } else if (value.available_actions.request == true) {
                return '<form action="<?php echo e(config('app.url')); ?>/account/request-asset/' + value.id +
                    '" method="POST"><?php echo csrf_field(); ?><button class="btn btn-block btn-primary btn-sm" data-tooltip="true" title="<?php echo e(trans('general.request_item')); ?>"><?php echo e(trans('button.request')); ?></button></form>';
            }
                ...
                if ((row.custom_fields[field_column_plain].field_format) && (row.custom_fields[field_column_plain].value)) {
                    if (row.custom_fields[field_column_plain].field_format == 'URL') {
                        ...
                        return '<a href="mailto:' + row.custom_fields[field_column_plain].value +
                            '" style="white-space: nowrap" data-tooltip="true" title="<?php echo e(trans('general.send_email')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
            ...
            if (value) {
                if ((value.indexOf("{") === -1) || (value.indexOf("}") === -1)) {
                    return '<nobr><a href="' + value +
                        '" target="_blank" title="<?php echo e(trans('general.external_link_tooltip')); ?> ' + value +
                        '" data-tooltip="true"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
        ...
        function groupsFormatter(value) {
            ...
            if (value) {
                ...
                for (var index in value.rows) {
                    groups += '<a href="<?php echo e(config('app.url')); ?>/admin/groups/' + value.rows[index].id +
        ...
        function changeLogFormatter(value) {
            ...
            for (var index in value) {
                ...
                result += extra_pretty_index + ': <del>' + value[index].old +
                    '</del>  <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'warning','class' => 'text-yellow']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
        ...
        function phoneFormatter(value) {
            if (value) {
                return '<span style="white-space: nowrap;"><a href="tel:' + value +
                    '" data-tooltip="true" title="<?php echo e(trans('general.call')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
        ...
        function mobileFormatter(value) {
            if (value) {
                return '<span style="white-space: nowrap;"><a href="tel:' + value +
                    '" data-tooltip="true" title="<?php echo e(trans('general.call')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'mobile']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?> ' + value +
        ...
        function deployedLocationFormatter(row, value) {
            if ((row) && (row != undefined)) {
                ...
                return '<a href="<?php echo e(config('app.url')); ?>/locations/' + value.rtd_location.id + '">' + value.rtd_location
                    .name + '</a>';
            }
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'x','class' => 'text-danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?><span class="sr-only"><?php echo e(trans('admin/hardware/general.deleted')); ?></span> <del><a href="<?php echo e(config('app.url')); ?>/hardware/' +
                        row.asset.id + '" data-tooltip="true" title="<?php echo e(trans('admin/hardware/general.deleted')); ?>">' +
        ...
        function departmentNameLinkFormatter(value, row) {
            if ((row.assigned_user) && (row.assigned_user.department) && (row.assigned_user.department.name)) {
                return '<a href="<?php echo e(config('app.url')); ?>/departments/' + row.assigned_user.department.id + '">' + row
...
<?php $component = $__componentOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?><span class="sr-only">deleted</span> <del><a href="<?php echo e(config('app.url')); ?>/hardware/' +
                        row.asset.id + '" data-tooltip="true" title="<?php echo e(trans('admin/hardware/general.deleted')); ?>">' +
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'checkmark','class' => 'text-success']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?> ' +
        ...
        function assetCompanyObjFilterFormatter(value, row) {
            if ((row) && (row.company)) {
                return '<a href="<?php echo e(config('app.url')); ?>/hardware/?company_id=' + row.company.id + '">' + row.company
                    .name + '</a>';
            }
        }
        ...
        function locationCompanyObjFilterFormatter(value, row) {
            if (value) {
                return '<a href="<?php echo e(url('/')); ?>/locations/?company_id=' + row.company.id + '">' + row.company.name +
                    '</a>';
            } else {
                return value;
            }
        ...
        function employeeNumFormatter(value, row) {
            ...
            if ((row) && (row.assigned_to) && ((row.assigned_to.employee_number))) {
                return '<a href="<?php echo e(config('app.url')); ?>/users/' + row.assigned_to.id + '">' + row.assigned_to
                    .employee_number + '</a>';
            }
        }
        ...
        function jobtitleFormatter(value, row) {
            if ((row) && (row.assigned_to) && ((row.assigned_to.jobtitle))) {
                return '<a href="<?php echo e(config('app.url')); ?>/users/' + row.assigned_to.id + '">' + row.assigned_to.jobtitle +
                    '</a>';
            }
        }
        ...
        function orderNumberObjFilterFormatter(value, row) {
            if (value) {
                return '<a href="<?php echo e(config('app.url')); ?>/hardware/?order_number=' + row.order_number + '">' + row
                    .order_number + '</a>';
            }
        }
        ...
        function auditImageFormatter(value) {
            if (value) {
                return '<a href="' + value.url + '" data-toggle="lightbox" data-type="image"><img src="' + value.url +
                    '" style="max-height: <?php echo e($snipeSettings->thumbnail_max_h); ?>px; width: auto;" class="img-responsive" alt=""></a>'
            }
        }
        ...
        function imageFormatter(value, row) {
            ...
            if (value) {
                ...
                return '<a href="' + value + '" data-toggle="lightbox" data-type="image"><img src="' + value +
                    '" style="max-height: <?php echo e($snipeSettings->thumbnail_max_h); ?>px; width: auto;" class="img-responsive" alt="' +
                    altName + '"></a>';
            }
        }
...
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
        ...
        function fileDownloadButtonsFormatter(row, value) {
            ...
            if (value) {
                ...
                var download_button = '<a href="' + download_url +
                    '" class="btn btn-sm btn-default" data-tooltip="true" title="<?php echo e(trans('general.download')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></a>';
                var download_button_disabled =
                    '<span data-tooltip="true" title="<?php echo e(trans('general.file_does_not_exist')); ?>"><a class="btn btn-sm btn-default disabled"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></a></span>';
                var inline_button = '<a href="' + download_url +
                    '?inline=true" class="btn btn-sm btn-default" target="_blank" data-tooltip="true" title="<?php echo e(trans('general.open_new_window')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'external-link']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></a>';
                var inline_button_disabled =
                    '<span data-tooltip="true" title="<?php echo e(trans('general.file_not_inlineable')); ?>"><a class="btn btn-sm btn-default disabled" target="_blank" data-tooltip="true" title="<?php echo e(trans('general.file_does_not_exist')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'external-link']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></a></span>';
            ...
            if ((value) && (value.url) && (value.inlineable)) {
                ...
                if (value.mediatype == 'image') {
                    ...
                    return '<a href="' + value.url +
                        '?inline=true" data-toggle="lightbox" data-type="video"><video style="max-height: <?php echo e($snipeSettings->thumbnail_max_h); ?>px; width: auto;" class="img-responsive"><source src="' +
        ...
        function deleteUploadFormatter(value, row) {
            ...
            if ((row.available_actions) && (row.available_actions.delete === true)) {
                ...
                return '<a href="<?php echo e(config('app.url')); ?>/' + destination + '/' + row.item.id + '/files/' + row.id +
                    '/delete" ' +
        ...
        window.customViewFormatter = data => {
            ...
            $.each(data, function(i, row) {
                ...
                if (row.exists_on_disk === true) {
                    ...
                    embed_code =
                        '<div class="text-center text-danger" style="padding-top: 20px;"><i class="fa-solid fa-heart-crack" style="font-size: 80px" /></i> <br><br><?php echo e(trans('general.file_upload_status.file_not_found')); ?></div>';
                }
                ...
                view += template.replace('%ID%', row.id)
                    ...
                    .replace('%FILENAME%', (row.exists_on_disk === true) ? row.filename :
                        '<?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'x']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?> <del>' + row.filename + '</del>')
                    ...
                    .replace('%DOWNLOAD_BUTTON%', (row.exists_on_disk === true) ? '<a href="' + row.url +
                        '" class="btn btn-sm btn-default"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?></a> ' :
                        '<span class="btn btn-sm btn-default disabled" data-tooltip="true" title="<?php echo e(trans('general.file_upload_status.file_not_found')); ?>"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></span>'
                    ...
                    .replace('%NEW_WINDOW_BUTTON%', (row.exists_on_disk === true) ? '<a href="' + row.url +
                        '?inline=true" class="btn btn-sm btn-default" target="_blank"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'external-link']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></span>'
                    ...
                    .replace('%DELETE_BUTTON%', (row.available_actions.delete === true) ?
                        '<a href="' + delete_url +
                        '" class="delete-asset btn btn-danger btn-sm" data-icon="fa-trash" data-toggle="modal" data-content="<?php echo e(trans('general.file_upload_status.confirm_delete')); ?> ' +
                        row.filename +
                        '?" data-title="<?php echo e(trans('general.delete')); ?>" onClick="return false;" data-target="#dataConfirmModal"><?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '53a84532857250ffb7b99fa272c3af08::icon','data' => ['type' => 'delete']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laravel\backup\snipe-it-8.3.3 - Copy\resources\views/partials/bootstrap-table.blade.php ENDPATH**/ ?>